...
class ExtraTreeEnsemble : public Regressor
{
    public:
        ...
        /**
          ...
          */
        ExtraTreeEnsemble(unsigned int input_size = 1,
         ...
         *
         */
        multimap<float, unsigned int> EvaluateFeatures(float initial_variance, float min_threshold = 0.0);
    ...
    private:
        ...
        boost::mutex mToken;	//token lock (parallel thread)
