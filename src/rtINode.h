...
***************************************************************************/
class rtINode :  public virtual rtANode
{
    public:
        ...
        /**
          * Empty constructor
          */
        rtINode() : axis( -1 ), split( 0 ), left( NULL ), right( NULL )
        {}
        ...
        /**
          ...
          */
        rtINode( int a, float s, rtANode* l, rtANode* r ) : axis( a ), split( s ), left( l ), right( r )
        {}
