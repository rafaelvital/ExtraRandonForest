...
typedef enum {OVERWRITE, APPEND} ModalityType;
typedef enum {EUCLIDEAN, MANHATTAN, MAHALANOBIS} MetricType;
...
class Dataset : public std::vector<Sample*>
{
    public:
         ...
         *
         */
        Dataset* GetReducedDataset(unsigned int size, unsigned* samples);
        /**
         *
         */
        ...
        *
        */
        void GetTrainAndTestDataset(unsigned int num_partitions,
